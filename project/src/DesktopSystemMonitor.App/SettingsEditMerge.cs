...
internal static class SettingsEditMerge
{
        ...
        bool resetBatteryChargeLearning = false)
    {
        AppSettings merged = (current with
        {
            ...
            DisplayMode = edited.DisplayMode,
            ...
            PlacementXRatio = edited.PlacementXRatio,
            PlacementYRatio = edited.PlacementYRatio,
            SavedWorkAreaWidthDip = edited.SavedWorkAreaWidthDip,
            SavedWorkAreaHeightDip = edited.SavedWorkAreaHeightDip,
