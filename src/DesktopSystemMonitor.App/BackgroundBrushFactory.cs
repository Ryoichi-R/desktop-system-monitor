...
internal static class BackgroundBrushFactory
{
        ...
        AppSettings settings)
    {
        ...
        double maskRatio = expansionRatio / (1d + expansionRatio);
    ...
    private static MediaLinearGradientBrush CreateHorizontalMask(double fade)
    {
        ...
        brush.GradientStops.Add(new MediaGradientStop(MediaColor.FromArgb(255, 255, 255, 255), 1));
        return Freeze(brush);
    }
    ...
    private static MediaLinearGradientBrush CreateVerticalMask(double fade)
    {
        ...
        brush.GradientStops.Add(new MediaGradientStop(MediaColor.FromArgb(255, 255, 255, 255), 0));
