...
internal sealed class SettingsFlowCompletionScope : IDisposable
{
    ...
    private readonly Action _releaseLayerRepair;
    ...
    public SettingsFlowCompletionScope(
        Action cleanup,
        Action releaseLayerRepair,
        Action reapplyWindowStyles,
        Action<Exception> onError)
    {
        _cleanup = cleanup ?? throw new ArgumentNullException(nameof(cleanup));
        _releaseLayerRepair = releaseLayerRepair ?? throw new ArgumentNullException(nameof(releaseLayerRepair));
