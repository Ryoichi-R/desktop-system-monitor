...
| Microsoft .NET runtime and runtime packages | 10.0.3, 10.0.2, and 5.0.0 | MIT and bundled third-party terms | <https://github.com/dotnet/dotnet> | `licenses/dotnet-runtime-10.0.3/` |
...
copied from the .NET 10.0.3 toolchain used to build the release. If the runtime
pack changes, the dependency fingerprint, this inventory, and the bundled .NET
legal files must be reviewed and updated before a new candidate is accepted.
